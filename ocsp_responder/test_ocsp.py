...
class CERT_PATH(StrEnum):
    V2G_ROOT = vault_path + "369019456327156306860918403816860190972268671709.pem"
    CPO_SUBCA_1 = vault_path + "643286782561963095837065370186075244339298115122.pem"
    CPO_SUBCA_2 = vault_path + "497418016606393584417535485863973473777007788114.pem"
    SECC_LEAF = vault_path + "490794422650056450387334090886337104868988665452.pem"
