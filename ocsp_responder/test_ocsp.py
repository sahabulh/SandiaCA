...
class CERT_PATH(StrEnum):
    V2G_ROOT = vault_path + "433470005020823209159582984106026358254642311987.pem"
    CPO_SUBCA_1 = vault_path + "284154316620321913482915722216808544616204308551.pem"
    CPO_SUBCA_2 = vault_path + "44548759274311288431724493509775807090430241825.pem"
    SECC_LEAF = vault_path + "553614163421445610257226915817337492392967060055.pem"
