...
async def create_subCA_cert(data: SUBCA_CERT, response: Response):
    if access_type == "full":
        ...
        builder = builder.add_extension(x509.AuthorityInformationAccess([x509.AccessDescription(AuthorityInformationAccessOID.OCSP, x509.UniformResourceIdentifier("http://csms.server:8001"))]), critical=False)
